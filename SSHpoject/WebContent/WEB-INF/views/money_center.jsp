...
<div align="center">
	<div style=" width: 210px; height: 250px;">
		<img style="height: 200px;width: 200px;" src="${filePath }" class="img-circle">
		<form action="${pageContext.request.contextPath }/user_upload.action?uid=${money.uid }"
	...
	<div style="width: 400px;">
		<div class="form-group" style="width: 600px;">
			<label for="firstname" class="col-sm-2 control-label">用户余额</label>
			<div class="col-sm-10" style="width: 300px">
				<input style="background-color: #e5e5e5;" readonly="readonly" type="text" class="form-control" name="username" value="${money.balance }"
					   placeholder="用户余额">
		...
		<div class="form-group" align="center" style="width: 600px;">
			<label for="lastname" class="col-sm-2 control-label">收货地址一</label>
			<div class="col-sm-10" style="width: 300px" align="center">
				<input type="text" class="form-control" name="password" value="${money.receive1 }"
					   placeholder="收货地址一">
			</div>
		</div>
		<div class="form-group" align="center" style="width: 600px;">
			<label for="lastname" class="col-sm-2 control-label">收货地址二</label>
			<div class="col-sm-10" style="width: 300px" align="center">
				<input type="text" class="form-control" name="realname" value="${money.receive2 }"
					   placeholder="收货地址二">
			</div>
		</div>
		<div class="form-group" align="center" style="width: 600px;">
			<label for="lastname" class="col-sm-2 control-label">收货地址三</label>
			<div class="col-sm-10" style="width: 300px" align="center">
				<input type="text" class="form-control" name="sex" value="${money.receive3 }"
					   placeholder="收货地址三">
			</div>
		</div>
		<div class="form-group" align="center" style="width: 600px;">
			<label for="lastname" class="col-sm-2 control-label">银行卡</label>
			<div class="col-sm-10" style="width: 300px" align="center">
				<input type="text" class="form-control" name="phone" value="${money.bankcard }"
					   placeholder="银行卡">
			</div>
		</div>
